...
class SubTask(models.Model):
    ...
    assigned_engineer = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='subtasks')
...
class WorkLog(models.Model):
    ...
    date_logged = models.DateField(help_text="Date the work was done")
...
class CustomerSatisfaction(models.Model):
    ...
    submitted_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='csat_submissions')
...
class LeaveRequest(models.Model):
    ...
    status = models.CharField(max_length=40, choices=STATUS_CHOICES, default='Pending L1 Approval')
    created_at = models.DateTimeField(auto_now_add=True)
